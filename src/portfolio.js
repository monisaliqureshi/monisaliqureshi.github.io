...
export const getSkills = () => fetchData("skills", { data: [] });

export const getDegrees = () => fetchData("degrees", { degrees: [] });
...
export const getProjectsHeader = () =>
  fetchData("projects-header", {
    title: "Projects",
    description:
...
export const getContactPageData = () =>
  fetchData("contact", {
    ...
    blogSection: {
      title: "Hire Me",
      subtitle: "You can reach me out from any contacts above...",
      link: "https://www.upwork.com/freelancers/~0154de438999b692ce",
      avatar_image_path: "blogs_image.svg",
    },
  });

export const getProjects = () => fetchData("projects", { data: [] });
